...
open(my $fh, '>', $filename);
print $fh "CONNECT SCHEMA \'/db2/usr/local/ess/data/ngcp.dfl|127.0.0.1|1110\' USER \'\' PASSWORD \'LOCDB327|CPDB126\'\n\n\n\nselect name, LASTACTI from ips where lastacti <> \'\' order by lastacti desc";
close $fh;
#Creates the SQL Script for Nitro device list
...
open(my $fh, '>', $filename);
print $fh "CONNECT SCHEMA \'/db2/usr/local/ess/data/ngcp.dfl|127.0.0.1|1110\' USER \'\' PASSWORD \'LOCDB327|CPDB126\'\n\n\n\nselect ipaddrss from IPS where devicety in (\'2\',\'4\',\'15\',\'12\',\'10\',\'0\',\'13\')";
close $fh;
