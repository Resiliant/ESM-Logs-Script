...
#df = pd.read_csv('C:/Users/melendez/Downloads/ESM-Logs-Script-master/ESM-Logs-Script-master/Correlation Rulesets/47-4000116.csv')
...
for ax, col in zip(axes.flat, df.columns):
    ax.pie(labels=df.index, autopct= '%.02f', colors=colors)
